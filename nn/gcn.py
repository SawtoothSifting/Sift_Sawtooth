if __name__ == "__main__":
    ...
    for epoch in range(50):
        ...
        #print('csv saved')
        print('Epoch {0} RANK {1} : Time Cost {2}'.format(epoch, global_rank, te-ts))
        with open('acc_gcnb3{}.csv'.format(global_rank), mode='a+', newline='') as file:
            writer = csv.writer(file)
            writer.writerow([epoch,accuracy,te-ts])
